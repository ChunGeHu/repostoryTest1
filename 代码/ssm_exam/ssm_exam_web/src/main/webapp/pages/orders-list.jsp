        ...
        <section class="content">    <!-- .box-body -->
            <div class="box box-primary">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='product-add.html'">
                            ...
                            <c:forEach items="${pageInfo.list}" var="order">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive btn-xs"  onclick="location.href='${pageContext.request.contextPath}/orders/findDetail?id=${order.id}'">
                                            详情
                                        </button>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/orders/findByPage?pageNo=1&rows=${pageInfo.pageSize}"
                                   aria-label="Previous">首页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findByPage?pageNo=${pageInfo.pageNum-1}&rows=${pageInfo.pageSize}">上一页</a>
                            </li>
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="num">
                                <li
                                        ...
                                        href="${pageContext.request.contextPath}/orders/findByPage?pageNo=${num}&rows=${pageInfo.pageSize}">${num}</a>
                                </li>
                            </c:forEach>

                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findByPage?pageNo=${pageInfo.pageNum+1}&rows=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/orders/findByPage?pageNo=${pageInfo.pages}&rows=${pageInfo.pageSize}"
